...
for (int i = 0; i < dataContext.getDataCount(); i++) {
    ...
    try {
        ...
        String blobName = ExecutionUtil.getDynamicProcessProperty("dpp blobName"); //Get the Blob URI that is the Host Name for the Storage Blob
    ...
    //Error has occure; capture the error and send it back out as a dynamic proecss property for it to be checked and handled.
        ...
        ExecutionUtil.setDynamicProcessProperty("dpp Azure GET TryCatch", ex.toString(), true);
