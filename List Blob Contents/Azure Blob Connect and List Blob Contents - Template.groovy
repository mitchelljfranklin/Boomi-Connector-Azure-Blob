...
for (int i = 0; i < dataContext.getDataCount(); i++) {
    ...
    try {
        ...
        String maxResults = ExecutionUtil.getDynamicProcessProperty("<$Dynamic Process Property Name$>"); //Get the Max Results; if not set then set to Maximum of 5,000 as blank or 0 cause the API to error
        //Max Results Check
        ...
        String nextMarker = ExecutionUtil.getDynamicProcessProperty("<$Dynamic Process Property Name$>");
